...
const controller_2 = require("./../src/kit_listing/controller");
...
function RegisterRoutes(app) {
    ...
    app.get('/kit-listing', ...((0, runtime_1.fetchMiddlewares)(controller_2.ListingController)), ...((0, runtime_1.fetchMiddlewares)(controller_2.ListingController.prototype.getAllKitListings)), async function ListingController_getAllKitListings(request, response, next) {
        let validatedArgs = [];
        try {
            validatedArgs = templateService.getValidatedArgs({ args: argsListingController_getAllKitListings, request, response });
            const controller = new controller_2.ListingController();
            await templateService.apiHandler({
    ...
    app.get('/kit-listing/:id', ...((0, runtime_1.fetchMiddlewares)(controller_2.ListingController)), ...((0, runtime_1.fetchMiddlewares)(controller_2.ListingController.prototype.getKitListingById)), async function ListingController_getKitListingById(request, response, next) {
        let validatedArgs = [];
        try {
    ...
    app.post('/kit-listing', ...((0, runtime_1.fetchMiddlewares)(controller_2.ListingController)), ...((0, runtime_1.fetchMiddlewares)(controller_2.ListingController.prototype.createNewKitListing)), async function ListingController_createNewKitListing(request, response, next) {
        let validatedArgs = [];
        try {
