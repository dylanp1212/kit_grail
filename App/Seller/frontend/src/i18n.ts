...
i18n.use(initReactI18next).init({
  resources: {
    en: {translation: {activeListings: 'Active Listings',
      ...
      orderTotal: 'Total',
      orderShopperUnknown: 'Unknown shopper',
    ...
    sp: {translation: {activeListings: 'Anuncios activos',
      ...
      language: 'Idioma', profile: 'Perfil',
      ...
      orderTotal: 'Total',
      orderShopperUnknown: 'Comprador desconocido',
      orderStatus_paid: 'Pagado',
      orderStatus_pending: 'Pendiente',
      orderStatus_fulfilled: 'Cumplido'}},
  },
  lng: locale,
  fallbackLng: 'en',
