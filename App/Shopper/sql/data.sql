...
INSERT INTO orders(id, shopper, data)
VALUES (
  'a1b2c3d4-0000-0000-0000-000000000001',
  'e86405c1-545b-4bef-912c-a9b01ee6d18f',
  jsonb_build_object(
    'stripe_session_id', 'cs_test_sally_order_1',
    'status', 'paid',
    'paid_at', '2026-05-01T10:00:00+00:00'::timestamptz
  )
);
...
VALUES (
  ...
  '3436e28c-8d0f-42e1-a733-eb42358ca451',
  jsonb_build_object(
    'stripe_session_id', 'cs_test_tommy_order_1',
    'status', 'paid',
    'paid_at', '2026-05-02T14:30:00+00:00'::timestamptz
  )
);
