...
export class WishlistService {
  public async getAllWishlistItems(userid: string, search?: string): Promise<WishlistItem[]> {
    const url = search
      ? `${MS_URL}/${userid}?search=${encodeURIComponent(search)}`
      : `${MS_URL}/${userid}`
